...
class Ui_dialogPreferences(object):
    def setupUi(self, dialogPreferences):
        ...
        dialogPreferences.resize(428, 261)
        dialogPreferences.setMaximumSize(QtCore.QSize(428, 261))
        ...
        self.spinIdleTimeout.setMaximum(60)
        ...
        self.gridLayout.addWidget(self.groupBuildDefaults, 4, 0, 1, 4)
        ...
        dialogPreferences.setTabOrder(self.spinCentrelineT, self.spinIdleTimeout)
        dialogPreferences.setTabOrder(self.spinIdleTimeout, self.lineBuildName)
    ...
    def retranslateUi(self, dialogPreferences):
        ...
        self.spinIdleTimeout.setToolTip(_translate("dialogPreferences", "1 - 60"))
