...
class Ui_dialogPreferences(object):
    def setupUi(self, dialogPreferences):
        ...
        dialogPreferences.resize(356, 410)
        ...
        self.gridLayout.addWidget(self.groupBuildDefaults, 6, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.groupNotification, 5, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.groupIdleTimeout, 4, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.groupImage, 4, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.groupSliceConverter, 3, 1, 1, 3)
