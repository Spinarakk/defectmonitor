...
class Ui_dialogNewBuild(object):
    def setupUi(self, dialogNewBuild):
        ...
        self.gridLayout.addWidget(self.pushCancel, 9, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushCreate, 8, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEmailAddress, 6, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.lineUsername, 5, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.checkAddAttachment, 9, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushSendTestEmail, 8, 0, 1, 2)
