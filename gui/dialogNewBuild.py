...
class Ui_dialogNewBuild(object):
    def setupUi(self, dialogNewBuild):
        ...
        self.buttonChangeIF = QtGui.QPushButton(dialogNewBuild)
        self.buttonChangeIF.setGeometry(QtCore.QRect(10, 180, 211, 28))
        self.buttonChangeIF.setObjectName(_fromUtf8("buttonChangeIF"))
        ...
        self.lineImageFolder = QtGui.QLineEdit(dialogNewBuild)
        self.lineImageFolder.setGeometry(QtCore.QRect(10, 146, 411, 26))
    ...
    def retranslateUi(self, dialogNewBuild):
        ...
        self.buttonChangeIF.setText(_translate("dialogNewBuild", "Change Image Folder", None))
