...
class Ui_dialogSliceConverter(object):
    def setupUi(self, dialogSliceConverter):
        ...
        self.buttonStartConversion.setGeometry(QtCore.QRect(10, 318, 291, 28))
        ...
        self.buttonDone.setGeometry(QtCore.QRect(310, 318, 91, 28))
        ...
        self.checkFill.setGeometry(QtCore.QRect(290, 148, 111, 28))
