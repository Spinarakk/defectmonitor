...
class Ui_dialogSliceConverter(object):
    def setupUi(self, dialogSliceConverter):
        ...
        dialogSliceConverter.setMinimumSize(QtCore.QSize(415, 288))
        dialogSliceConverter.setMaximumSize(QtCore.QSize(415, 288))
        icon = QtGui.QIcon()
        ...
        self.labelStatusSlice.setGeometry(QtCore.QRect(10, 148, 391, 28))
        ...
        self.checkCombine.setGeometry(QtCore.QRect(270, 114, 131, 28))
