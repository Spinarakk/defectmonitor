...
class Ui_dialogSliceConverter(object):
    def setupUi(self, dialogSliceConverter):
        ...
        self.buttonStart = QtGui.QPushButton(dialogSliceConverter)
    ...
    def retranslateUi(self, dialogSliceConverter):
        ...
        self.buttonStart.setText(_translate("dialogSliceConverter", "Start", None))
        ...
        self.labelStatusSlice.setText(_translate("dialogSliceConverter", "Current Part: None", None))
