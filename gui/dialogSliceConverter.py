...
class Ui_dialogSliceConverter(object):
    def setupUi(self, dialogSliceConverter):
        ...
        dialogSliceConverter.resize(381, 244)
        icon = QtGui.QIcon()
        ...
        self.buttonStartConversion.setGeometry(QtCore.QRect(10, 206, 261, 28))
        ...
        self.buttonDone.setGeometry(QtCore.QRect(280, 206, 91, 28))
        self.buttonDone.setObjectName(_fromUtf8("buttonDone"))
        self.progressBar = QtGui.QProgressBar(dialogSliceConverter)
        self.progressBar.setGeometry(QtCore.QRect(10, 172, 361, 28))
        ...
        self.labelStatus.setGeometry(QtCore.QRect(10, 138, 361, 28))
        ...
        self.checkContours.setGeometry(QtCore.QRect(220, 104, 131, 28))
        self.checkContours.setObjectName(_fromUtf8("checkContours"))
        self.checkPolygons = QtGui.QCheckBox(dialogSliceConverter)
        self.checkPolygons.setGeometry(QtCore.QRect(60, 104, 141, 28))
        self.checkPolygons.setObjectName(_fromUtf8("checkPolygons"))
    ...
    def retranslateUi(self, dialogSliceConverter):
        ...
        self.checkPolygons.setText(_translate("dialogSliceConverter", "Draw Polygons", None))
