...
class Ui_dialogCameraCalibration(object):
    def setupUi(self, dialogCameraCalibration):
        ...
        dialogCameraCalibration.resize(411, 510)
        dialogCameraCalibration.setMinimumSize(QtCore.QSize(411, 510))
        dialogCameraCalibration.setMaximumSize(QtCore.QSize(411, 510))
        icon = QtGui.QIcon()
        ...
        self.buttonStartCalibration.setGeometry(QtCore.QRect(210, 438, 191, 28))
        ...
        self.buttonDone.setGeometry(QtCore.QRect(210, 472, 191, 28))
        ...
        self.checkApply.setGeometry(QtCore.QRect(10, 472, 191, 28))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.checkApply.setFont(font)
        self.checkApply.setObjectName(_fromUtf8("checkApply"))
        self.labelRMS = QtGui.QLabel(dialogCameraCalibration)
        self.labelRMS.setGeometry(QtCore.QRect(212, 404, 191, 28))
    ...
    def retranslateUi(self, dialogCameraCalibration):
        ...
        self.label2.setToolTip(_translate("dialogCameraCalibration", "Sets the number of square corners the width of the checkerboard has.", None))
        self.label2.setText(_translate("dialogCameraCalibration", "Checkerboard Width", None))
        self.label3.setToolTip(_translate("dialogCameraCalibration", "Sets the number of square corners the height of the checkerboard has.", None))
        ...
        self.spinRatio.setToolTip(_translate("dialogCameraCalibration", "2 - 4", None))
        self.checkApply.setText(_translate("dialogCameraCalibration", "Apply to Sample Image", None))
        self.labelRMS.setText(_translate("dialogCameraCalibration", "RMS Value:", None))
