...
class Ui_dialogCameraCalibration(object):
    def setupUi(self, dialogCameraCalibration):
        ...
        dialogCameraCalibration.resize(338, 412)
        ...
        self.gridLayout.addWidget(self.frameButtons, 10, 0, 1, 4)
        ...
        self.groupBox = QtWidgets.QGroupBox(dialogCameraCalibration)
    ...
    def retranslateUi(self, dialogCameraCalibration):
        ...
        self.groupBox.setTitle(_translate("dialogCameraCalibration", "Crop Settings"))
