...
class Ui_dialogCameraCalibration(object):
    def setupUi(self, dialogCameraCalibration):
        ...
        dialogCameraCalibration.resize(395, 401)
        ...
        dialogCameraCalibration.setTabOrder(self.spinWidth, self.spinWidthHI)
        dialogCameraCalibration.setTabOrder(self.spinWidthHI, self.spinHeight)
        dialogCameraCalibration.setTabOrder(self.spinHeight, self.spinHeightHI)
        dialogCameraCalibration.setTabOrder(self.spinHeightHI, self.spinRatio)
        ...
        dialogCameraCalibration.setTabOrder(self.checkApply, self.spinTLX)
        dialogCameraCalibration.setTabOrder(self.spinTLX, self.spinTLY)
        dialogCameraCalibration.setTabOrder(self.spinTLY, self.spinResolutionX)
        dialogCameraCalibration.setTabOrder(self.spinResolutionX, self.spinResolutionY)
        dialogCameraCalibration.setTabOrder(self.spinResolutionY, self.pushCropImage)
        dialogCameraCalibration.setTabOrder(self.pushCropImage, self.pushViewResults)
        dialogCameraCalibration.setTabOrder(self.pushViewResults, self.pushSaveResults)
        dialogCameraCalibration.setTabOrder(self.pushSaveResults, self.pushStart)
        dialogCameraCalibration.setTabOrder(self.pushStart, self.pushDone)
