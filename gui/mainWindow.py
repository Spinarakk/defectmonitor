...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.sliderRM = QtGui.QSlider(self.widgetTab4)
        self.sliderRM.setOrientation(QtCore.Qt.Vertical)
        self.sliderRM.setTickPosition(QtGui.QSlider.TicksBelow)
        self.sliderRM.setObjectName(_fromUtf8("sliderRM"))
        self.gridLayout_7.addWidget(self.sliderRM, 1, 1, 1, 1)
        self.labelLayerNoRM = QtGui.QLabel(self.widgetTab4)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.labelLayerNoRM.setFont(font)
        self.labelLayerNoRM.setAlignment(QtCore.Qt.AlignCenter)
        self.labelLayerNoRM.setObjectName(_fromUtf8("labelLayerNoRM"))
        self.gridLayout_7.addWidget(self.labelLayerNoRM, 0, 1, 1, 1)
        self.labelDisplayRM = QtGui.QLabel(self.widgetTab4)
        font = QtGui.QFont()
        font.setPointSize(19)
        font.setBold(True)
        font.setWeight(75)
        self.labelDisplayRM.setFont(font)
        self.labelDisplayRM.setScaledContents(True)
        self.labelDisplayRM.setAlignment(QtCore.Qt.AlignCenter)
        self.labelDisplayRM.setWordWrap(True)
        self.labelDisplayRM.setObjectName(_fromUtf8("labelDisplayRM"))
        self.gridLayout_7.addWidget(self.labelDisplayRM, 0, 0, 2, 1)
        ...
        self.pushButton = QtGui.QPushButton(self.mainWidget)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.labelLayerNoRM.setText(_translate("mainWindow", "1", None))
        self.labelDisplayRM.setText(_translate("mainWindow", "Image Capture > Run", None))
        self.widgetDisplay.setTabText(self.widgetDisplay.indexOf(self.widgetTab4), _translate("mainWindow", "Run Monitor", None))
        self.checkSimulation.setToolTip(_translate("mainWindow", "Check this to use and process pre-taken sample images.", None))
        self.checkSimulation.setText(_translate("mainWindow", "Simulation", None))
        self.checkCleanup.setToolTip(_translate("mainWindow", "Check this to delete all created folders (and their contents) upon closing the program.", None))
