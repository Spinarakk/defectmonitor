...
class Ui_dialogDefectReports(object):
    def setupUi(self, dialogDefectReports):
        ...
        self.gridLayout.addWidget(self.labelInformation, 3, 0, 1, 2)
    ...
    def retranslateUi(self, dialogDefectReports):
        ...
        self.labelInformation.setText(_translate("dialogDefectReports", "Double click on a row\'s cell to display that layer\'s defect image."))
